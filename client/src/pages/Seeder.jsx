...
const DROPSHIP_PRODUCTS = [
  ...
  },
  {
    ...
    longDescription: 'Pack of 50 premium vinyl stickers — waterproof, peel-and-stick, zero wall damage. Choose your style: Vintage Retro (butterflies, flowers, cottagecore) or JDM Cars (racing, anime car culture). Perfect for room walls, laptops, water bottles, journals, and phone cases. Repositionable — no sticky residue left behind. Free delivery. Available in 2 styles.',
    category: 'Home',
    department: 'Decor',
    regularPrice: 349,
    discountPrice: 249,
    deliveryCharge: 0,
    taxRate: 18,
    searchKeywords: ['wall stickers', 'room decor', 'aesthetic stickers', 'vinyl stickers', 'laptop stickers', 'jdm stickers', 'vintage stickers', 'pack of 50'],
    ...
    colors: [
      { name: 'Vintage Retro', hex: '#c9a962', images: ['', '', '', ''] },
      { name: 'JDM Cars', hex: '#ef4444', images: ['', '', '', ''] },
    ],
    supplierLink: 'https://www.meesho.com',
  },
  {
