...
const DROPSHIP_PRODUCTS = [
  ...
  {
    retailHeading: 'Posture Corrector Belt — Back & Shoulder Support',
    longDescription: 'Fix your posture in weeks, not months. Gently pulls your shoulders back to align your spine naturally. One size fits all with fully adjustable straps. Lightweight and breathable — wear under any clothing at college, office, or home. Helps with herniated disc, scoliosis, shoulder pain, and back ache. Trusted by students, desk workers, and gamers.',
    category: 'Health',
    department: 'Wellness',
    regularPrice: 699,
    discountPrice: 499,
    deliveryCharge: 0,
    taxRate: 12,
    searchKeywords: ['posture corrector', 'back support', 'posture belt', 'back brace', 'spine support', 'shoulder support', 'pain relief', 'scoliosis'],
    ...
    supplierLink: 'https://www.amazon.in/Posture-Corrector-Shoulder-Straightener-Correction/dp/B08NXJ75FS',
  },
  {
